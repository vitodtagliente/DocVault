...
const translations = {
  en: {
    ...
    'sync.authenticating': 'Waiting for browser authentication…',
    'sync.authenticatingHint': 'A browser window was opened. Complete authentication there, then return here.',
    'sync.authSuccess': 'Connected to Google Drive!',
  ...
  it: {
    ...
    'sync.authenticating': 'In attesa dell\'autenticazione nel browser…',
    'sync.authenticatingHint': 'È stata aperta una finestra del browser. Completa l\'autenticazione lì, poi torna qui.',
    'sync.authSuccess': 'Connesso a Google Drive!',
